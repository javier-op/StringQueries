...
data_dir = "/home/javierin/Git/StringQueries/results/"
output_dir = "img/"
...
plt.clf()
plt.plot(unique_k_e, avg_topkq_per_k_e / 10**6, '*--')
plt.plot(unique_k_d, avg_topkq_per_k_d / 10**6, '*--')
plt.ylim(0, 80)
plt.legend(['English text', 'DNA sequence'])
plt.xlabel("k value")
...
plt.clf()
plt.plot(unique_q_d, avg_topkq_per_q_d / 10**6, '*--')
plt.ylim(0, plt.ylim()[1])
plt.xlabel("q value")
plt.ylabel("Average time of top-k-q [ms]")
plt.tight_layout()
